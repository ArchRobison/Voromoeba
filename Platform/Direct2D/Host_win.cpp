...
static short WindowWidth = ExclusiveMode ? 1024 : 1024+8;
static short WindowHeight = ExclusiveMode ? 600 : 600+34;
#endif
...
static void UpdateAndDraw(HWND hwnd) {
    ...
    GameUpdateDraw(pixmap, NimbleRequest::update|NimbleRequest::draw);
